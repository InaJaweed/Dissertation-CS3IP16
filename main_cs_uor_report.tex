...
%  \noindent\immediate\write18{texcount -1 -sum -merge -q #1.tex output.bbl > #1-words.sum }%
%  \input{#1-words.sum} words%
%}

%\newcommand{\totalwordcount}{%
%  \immediate\write18{texcount -1 -sum -merge -q chapters/*.tex output.bbl > total-words.sum}%
%  \input{total-words.sum} Total%
%}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
    %\quickwordcount{chapters/abstract} abstract\\
    %\quickwordcount{chapters/introduction} introduction\\ 
    %\quickwordcount{chapters/literature} literature \\
    %\quickwordcount{chapters/methodology} methodology \\
    %\\
    %\quickwordcount{chapters/results} results 
    %\\
    %\quickwordcount{chapters/discussion} discussion \\
    %\quickwordcount{chapters/conclusions} conclusion \\
    %\quickwordcount{chapters/reflection} reflection \\\\
    %\totalwordcount
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            {\large 
                ...
                \emph{Supervisor:} Prof Shuang-Hua Yang}\\[1cm] % if applicable
    ...
    I,
    %%%%%%%%%%%%%%%%%%%%%%%
     Jaweed Inayathulla, % Mandatory part
    %%%%%%%%%%%%%%%%%%%%%%%
	...
	Jaweed Inayathulla % Please change it to your name
